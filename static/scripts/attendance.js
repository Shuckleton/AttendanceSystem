...
const barangayMap = {
    ...
    document.getElementById('filter-btn').addEventListener('click', fetchAttendanceRecords);


    async function fetchAttendanceRecords() {
        const employeeId = document.getElementById('employee-dropdown').value; // Get selected employee ID
        const date = document.getElementById('filter-date').value; // Get selected date
        ...
        try {
            const response = await fetch('/get_attendance_records', {
                ...
                body: JSON.stringify({ date, employee: employeeId }), // Pass date and employee ID
            });
    ...
    // You can define your export logic here, for example:
    const employeeId = document.getElementById('employee-dropdown').value; // Get selected employee ID
    const date = document.getElementById('filter-date').value; // Get selected date
